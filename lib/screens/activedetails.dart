...
class ActiveDetails extends StatefulWidget {
  ...
  ActiveDetails({Key key, @required this.tickets}) : super(key: key);
  State<StatefulWidget> createState() => ActiveDetailsState();
}

class ActiveDetailsState extends State<ActiveDetails> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
